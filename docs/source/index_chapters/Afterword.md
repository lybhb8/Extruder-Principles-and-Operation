...
翻译的起点，是一台 PDF 解析器。[MinerU](https://github.com/opendatalab/MinerU)（上海人工智能实验室开源的文档解析工具）把英文版 PDF 拆成了结构化文本——公式转成 LaTeX、表格与图片按版式切分。对这样一本满是流体力学方程和工艺对照表的书，这一步省去了大量手抄。骨架既成，初稿的推进比想象中顺利，也比想象中粗糙：现代化的吃力处，在于我们大量借助机器翻译——谷歌翻译等 AI 工具——在短时间内铺出全书。效率的代价随之而来：专业术语生硬、句式带着译腔、"挤出"与"挤压"混用、"模具"与"模头"莫衷一是。2023 年 9 月启动后，process、flow、viscosity、slit 等早期章节相继入库，然后是近一年的沉寂——2024 年全年，仓库里几乎只有 README 的零星维护。翻译的马拉松，跑一段停一段，是常态。

转折发生在 2025 年初。第 3、4、5 章的提交密集起来，3.2.3、4.0、5.30、5.6……一个个章号从提交信息里跳过，像施工进度表上的对勾。2026 年初，第 6、7 章跟上；同年 8 月，文档被重构为编号章节结构，第 8 章图片的链接路径从反斜杠和绝对路径逐一改成相对路径；8 月 28 日，提交信息里出现了"trans_end"——翻译主体，至此画上句号。但"画上句号"在翻译这件事上从来只是修辞。之后的九、十、十一、十二章与附录相继收尾，紧接着是更漫长、更琐碎的第二战场：校译。
