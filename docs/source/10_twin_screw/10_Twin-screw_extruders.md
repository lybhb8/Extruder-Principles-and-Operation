...
| Land width | mm | 4.65 | 1.67 |
| --- | --- | --- | --- |
| Axis gap area (two per pitch) | $mm^2$ | 62.6 | 137.1 |
| Channel cross-section  $ph/2+gap area$ | $mm^2$ | 312.6 | 387.1 |
| Axis gap area Channel area | % | 20.0 | 35.4 |
| Smaller mid-plane gap | $mm^2$ % | 24.67.9 | 107.827.9 |
| Larger mid-plane gap | $mm^2$ % | 19662.7 | 27972.2 |
| Smaller gap area Larger gap area | % | 12.5 | 38.6 |
...
| Residence time and distribution | Medium/wide | Low/narrow (useful for reaction) |
| Effect of back pressure on output | Reduces output | Slight/moderate effect on output |
| Shear in channel | High (useful for stable polymers) | Low (useful for PVC) |
| Overall mixing | Poor/medium | Good (useful for compounding) |
| Power absorption and heat generation | High (may be adiabatic) | Low (mainly conductive heating) |
| Maximum screw speed | High (output limited by melting, stability, etc.) | Medium (limits output) |
